...
const  obtenerPartidos =  async () =>{
 ...
 const  obtenerJugadores =  async () =>{
  await fetch(`https://futbol--back.herokuapp.com/getJugadoresClub?idClub=${props.location.state.club.idClub}`)
   .then(response =>response.json())
   .then(response => {
     ...
     console.log(e);
       ...
       const eliminar =   () => {
        ...
        if(buscarJugador!="IdJugadores"){
          ...
          fetch(`https://futbol--back.herokuapp.com/BajaJugadorPartido?clubAux=${props.location.state.club.idClub}&partidoAux=${buscarPartidos}&jugadorAux=${buscarJugador}`, requestOptions )
          .then( () => {
