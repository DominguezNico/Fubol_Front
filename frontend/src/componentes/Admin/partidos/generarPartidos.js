...
const  obtenerClubes =  async () =>{
 ...
 const crearPartido= () => {
  ...
  if(buscarClubes!="IdClubes"){
    ...
    fetch(`https://futbol--back.herokuapp.com/agregarPartido?nroFecha=${nroFecha}&nroZona=${nroZona}&categoria=${categoria}&idClubLocal=${buscarClubes}&idClubVisitante=${buscarClubesVisitantes}&fechaPartido=${fechaPart}&idCampeonato=${buscarCampeonatos}&etapa=${etapa}`, requestOptions )
    .then( () => {
