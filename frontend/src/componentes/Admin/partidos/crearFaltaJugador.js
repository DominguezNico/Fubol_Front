 ...
 const  obtenerJugadores =  async () =>{
  ...
  const crearFalta =   () => {
    ...
    if(buscarPartidos!="IdPartidos"){
      ...
      fetch(`https://futbol--back.herokuapp.com/addFalta?minuto=${minuto}&tipo=${tipo}&idJugador=${buscarJugador}&idPartido=${buscarPartidos}&idCampeonato=${buscarCampeonato}`, requestOptions )
      .then( () => {
