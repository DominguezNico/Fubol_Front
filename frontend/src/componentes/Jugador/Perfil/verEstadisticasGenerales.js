...
function VerEstadisticas (props){
  ...
  const obtenerFaltas = async () =>{
    ...
    await fetch(`https://futbolito-back.herokuapp.com/getFaltasJugador?idJugador=${props.location.state.id}`)
  ...
  const obtenerGoles = async () =>{
    ...
    await fetch(`https://futbolito-back.herokuapp.com/getGolesJugador?idJugador=${props.location.state.id}`)
      .then(response =>response.json())
      .then(response => {
  ...
  const obtenerPartidosGanados = async () =>{
    ...
    await fetch(`https://futbolito-back.herokuapp.com/partidosGanados?idClub=${props.location.state.idClub}`)
    .then(response =>response.json()) 
    .then(response => {
  ...
  const obtenerPartidosPerdidos = async () =>{
    ...
    await fetch(`https://futbolito-back.herokuapp.com/partidosPerdidos?idClub=${props.location.state.idClub}`)
    .then(response =>response.json())   
    .then(response => {
